...
namespace english {
    ...
    void Game::onCreate() {
        ...
        _daan1->setClickCallback(app::bind(&Game::onClick, this));
        ...
        _daan2->setClickCallback(app::bind(&Game::onClick, this));
        ...
        _daan3->setClickCallback(app::bind(&Game::onClick, this));
        ...
        _daan4->setClickCallback(app::bind(&Game::onClick, this));
        ...
        _continue->setClickCallback(app::bind(&Game::onClick, this));
